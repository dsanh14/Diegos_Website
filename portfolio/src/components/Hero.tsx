...
export default function Hero() {
  return (
    <section className="min-h-screen px-6 py-32 sm:px-8 md:px-12 lg:px-16 xl:px-24">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row items-start gap-16">
          ...
          <motion.div
            ...
            className="w-72 h-72 rounded-full overflow-hidden flex-shrink-0 mx-auto md:mx-0"
          >
            <Image
              src="/profile.jpg"
              alt="Profile"
