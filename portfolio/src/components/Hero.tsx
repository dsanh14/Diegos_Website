...
export default function Hero() {
  return (
    <section className="min-h-screen px-6 py-8">
      <nav className="flex justify-end gap-8 mb-32">
        <Link href="/" className="hover:opacity-70 transition-opacity">
          Home
        </Link>
        <Link href="/experience" className="hover:opacity-70 transition-opacity">
          Experience
        </Link>
        <Link href="/projects" className="hover:opacity-70 transition-opacity">
          Projects
        </Link>
        <Link href="/classes" className="hover:opacity-70 transition-opacity">
          Classes
        </Link>
      </nav>
